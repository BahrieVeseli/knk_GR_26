...
public class Udhetime {
    ...
    public static Udhetime of(int udhetimId, int orariId, LocalDate data, int pasagjeret, String statusi) {
        return new Udhetime(udhetimId, orariId, data, pasagjeret, statusi);
    }
